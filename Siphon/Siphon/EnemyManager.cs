    ...
    class EnemyManager
    {
        ...
        public void BeginNextWave()
        {
            ...
            for (int i = 0; i < (waveNumber * 15); ++i)
            {
                ...
                AddToList(new StarterEnemy(enemyCoords, plugEnemyModel, bar, mainStructure, map.Turrets, player));
                AddToList(new StarterEnemy(enemyCoords, plugEnemyModel, bar, mainStructure, map.Turrets, screenHeight));
            }
            #endregion
        }
